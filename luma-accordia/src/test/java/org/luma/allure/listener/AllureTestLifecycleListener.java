/**
 * Could not make manually Allure attach the screenshot to the test itself for some reason
 * Solution borrowed from here : https://github.com/biczomate/allure-testng7.5-attachment-example
 */

package org.luma.allure.listener;
